...
void genidentity( float**, int, int );
...
int main( int argc, char** argv ) {
  ...
  */
  ...
  genrandmat( B, row2, col2, lo1, hi1 );
  genidentity( A, row1, col1 );
  //genidentity( B, row2, col2 );
  ...
  if ( row1 <= 12 && col2 <= 12 ) {
    cout << "A matrix =" << endl;
    printmat( A, row1, col1 );
    
    cout << "B matrix =" << endl;
    printmat( B, row2, col2 );
...
void genidentity( float** A, int m, int n ) {
  /* This function generates an identity matrix
   */
